...
function Sidebar({ collapsed, onToggle, mobileMenuOpen, setMobileMenuOpen }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 z-40 h-screen w-[260px] border-r border-gray-200 bg-white text-gray-700 transition-all duration-200 lg:translate-x-0 ${
